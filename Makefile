...
CFLAGS+= -fno-pic -no-pie -DPROJECT_VERSION=0.2.0 -DSOKOL_GLCORE33 -D_POSIX_C_SOURCE=200809L -O2 -Wall -pedantic -std=c99
CXXFLAGS+= -fno-pic -no-pie -DPROJECT_VERSION=0.2.0 -DSOKOL_GLCORE33 -D_POSIX_C_SOURCE=200809L -O2 -Wall -pedantic -std=c++11
